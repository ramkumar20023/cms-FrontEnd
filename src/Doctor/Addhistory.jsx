...
const AddPatientHistory = () => {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([labRes, consultRes, doctorRes]) => {
        setLabTests(labRes.data);
        setConsultations(consultRes.data);
        setDoctors(doctorRes.data);

        console.log("docotor", doctorRes.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8000/api/patienthistory/", data, header)
      .then(() => {
  ...
  return (
    <div>
      ...
      <div className="container mt-5">
        ...
        >
          <h3 className="text-center mb-4 text-white bg-primary p-3">Add Patient History</h3>
          <div className="mb-3">
